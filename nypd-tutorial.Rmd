...
```{r add_labels_exercise, exercise = TRUE, eval = FALSE}
# Write your code here
...
```{r facet_color_exercise, exercise = TRUE, eval = FALSE}
# Write your code here
...
```{r exercise_theme_1, exercise = TRUE, eval = FALSE, fig.height = FIG_HEIGHT}
# Write your code here
...
```{r exercise_theme_2, exercise = TRUE, eval = FALSE, fig.height = FIG_HEIGHT}
# Write your code here
...
```{r apply_theme_exercise, exercise = TRUE, eval = FALSE}
# Write your code here
